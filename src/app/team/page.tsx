  ...
  return (
    <main className="min-h-screen bg-white text-black">
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-10 py-12 md:py-16">
        <h2 className="text-3xl md:text-4xl font-bold tracking-wide mb-10 md:mb-12 pb-4 border-b border-gray-200 text-black">
          Meet the Plebanek Lab
        </h2>

        <div className="flex flex-col md:flex-row items-start gap-8 mb-16 md:mb-20">
          {/* PI Photo */}
          <div className="w-full md:w-[260px] shrink-0 flex justify-center md:justify-start">
            <img
        ...
        {/* JOIN US SECTION */}
        <div>
          <h2 className="text-2xl md:text-3xl font-bold tracking-wide mb-6 pb-4 border-b border-gray-200 text-[#18453B]">
            Join Us
          </h2>
