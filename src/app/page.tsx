...
export default function Home() {
  return (
    <main className="min-h-screen bg-white text-black">
      ...
      {/* HERO */}
      <section className="px-6 md:px-10 py-10 md:py-14 bg-[#F8F8F6]">
        <div className="max-w-7xl mx-auto">
          <h2 className="mt-4 md:mt-8 text-3xl sm:text-5xl md:text-6xl font-bold leading-tight tracking-tight">
            Understanding how myeloid cells regulate immunity, inflammation, and disease.
          </h2>
          <p className="mt-6 md:mt-10 text-lg md:text-xl text-gray-600 leading-relaxed md:leading-9 max-w-4xl">
      ...
      {/* RESEARCH THEMES */}
      <section className="px-6 md:px-10 py-12 md:py-16 border-t border-gray-200">
        <div className="max-w-7xl mx-auto">
          <h3 className="text-2xl md:text-3xl font-bold text-[#18453B]">
            Research Focus
          </h3>

          <div className="mt-10 md:mt-16 grid md:grid-cols-3 gap-12 md:gap-20">
            ...
            <div className="flex flex-col">
              ...
              <img
                ...
                className="mt-6 w-full h-[250px] object-cover rounded-xl"
              />
            </div>
            ...
            <div className="flex flex-col">
              ...
              <img
                ...
                className="mt-6 w-full h-[260px] object-cover rounded-xl"
              />
            </div>
